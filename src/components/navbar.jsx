...
const Navbar = () => {
  ...
  return (
    <div className="navbar">
      <div
        className={
          "navbar bg-black " + (scroll ? "opacity-100" : "h-24 opacity-0")
        }
      ></div>
      <div
        className={
          "z-[1] font-poppins sticky flex flex-row container mx-auto px-12 text-center items-center text-lg font-semibold " +
      ...
      >
        ...
        <div className="flex gap-6 text-base">
          ...
          <button
            className={
              "border-2 py-2 px-6 rounded-full transform duration-300 ease " +
              (scroll
